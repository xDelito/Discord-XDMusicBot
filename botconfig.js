module.exports = {
  ...
  SupportServer: "https://discord.gg/security", // Support Server Link
  ...
  Lavalink: {
    id: "lavateputo", //- Used for indentifier. You can set this to whatever you want.
    host: "https://lavateputo.herokuapp.com/", //- The host name or IP of the lavalink server.
    port: 80, // The port that lavalink is listening to. This must be a number!
    pass: "XDBruh", //- The password of the lavalink server.
